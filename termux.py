...
#    runntxt(h+"     Assalamu'alaikum       .")
    ...
    maskedclown ("\ra|  Team  :\rh Indonesian Cyber Army")
    maskedclown ("\ra|  github:\rh https://www.github.com/KingRenjazu")
    print s+"|   +-----------------------------------------+"
    maskedclown("\rm|   | \rm[\rs1\rm]\rk  Ubah tampilan termux kamu sekarang          |")
    maskedclown("\rm|   | \rm[\rs2\rm]\rk  Cara Mengedit                      |")
    maskedclown("\rm|   | \rm[\rs3\rm]\rh  Install paketnya first     |")
    print s+"+---+-----------------------------------------+"
    print m+"    4. Exit "
def main():
    banner()
    print a+",~~~~~",h+"[",s+" Pilih Opsinya ",h+"]"
    satriamnd = input("\033[96m'~~~~~>   ")
    if satriamnd == 1:
        pertama()
        runntxt(w+"...................")
        print " "
        ...
        print "  "
        runntxt(a+" Silahkan buka sesi termux baru")
        print " "
        print " "
    elif satriamnd == 2:
